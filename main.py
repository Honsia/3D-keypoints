...
def args():
    ...
    parser.add_argument('--w', '--weight-file', type=str, default='/Users/lele/PyProject/Human3d-keypoints/lib/checkpoint/epoch_120_333.bin', help='The path')
